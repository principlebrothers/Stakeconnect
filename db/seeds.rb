...
admin_parent_teacher_1 = AdministratorParentTeacher.create(administrator_id: admin_1.id, parent_id: parent_1.id, teacher_id: teacher_1.id)
admin_parent_teacher_2 = AdministratorParentTeacher.create(administrator_id: admin_1.id, parent_id: parent_2.id, teacher_id: teacher_2.id)
admin_parent_teacher_3 = AdministratorParentTeacher.create(administrator_id: admin_1.id, parent_id: parent_3.id, teacher_id: teacher_3.id)
...
english_homework = HomeworkResult.create(date: Date.tomorrow, score: 85, course_id: english.id, student_id: student_1.id)
...
science_homework = HomeworkResult.create(date: Date.tomorrow, score: 85, course_id: science.id, student_id: student_2.id)
