...
# Create Teachers
teacher_1 = Teacher.create(name: 'John Defoe', number: '0505651234', email: 'defoe@email.com', password: 'Pass@In1243', image: 'image')
teacher_2 = Teacher.create(name: 'Obrempong Sikani', number: '0595651234', email: 'obremp@email.com', password: 'Obemp4@m', image: 'image')
teacher_3 = Teacher.create(name: 'Kwame Nkrumah', number: '0277651234', email: 'kwamenkrumah@emai.com', password: 'Kwame@Nkrumah', image: 'image')

# Create Parents
parent_1 = Parent.create(name: 'Parent', number: '0554651234', email: 'parents@email.com', password: 'Pass@@In13', image: 'image', address: '27 Oxford St.')
parent_2 = Parent.create(name: 'Mr. Odei', number: '0254653234', email: 'response@email.com', password: 'Parass@@In13', image: 'image', address: '100 Main St.')
parent_3 = Parent.create(name: 'Augustine B.', number: '0554651204', email: 'augustine@email.com', password: 'Augustine@@In1', image: 'image', address: '27 Augustine St.')
