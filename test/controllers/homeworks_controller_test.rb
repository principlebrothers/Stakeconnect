...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create homework' do
    assert_difference('Homework.count') do
      post homeworks_url,
           params: { homework: { course_id: @homework.course_id, end_date: @homework.end_date, question: @homework.question, start_date: @homework.start_date } }, as: :json
    end
