...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create administrator' do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { type: @administrator.type } }, as: :json
    end
  ...
  test 'should update administrator' do
    patch administrator_url(@administrator), params: { administrator: { type: @administrator.type } }, as: :json
    assert_response :success
  end
